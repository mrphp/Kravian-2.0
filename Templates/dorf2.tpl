...
echo '<img class="ww g40 g40_0" src="img/x.gif" alt="Worldwonder">'; }
if($village->resarray['f99'] >= 20 && $village->resarray['f99'] <= 39) {
echo '<img class="ww g40 g40_1" src="img/x.gif" alt="Worldwonder">'; }
if($village->resarray['f99'] >= 40 && $village->resarray['f99'] <= 59) {
echo '<img class="ww g40 g40_2" src="img/x.gif" alt="Worldwonder">'; }
if($village->resarray['f99'] >= 60 && $village->resarray['f99'] <= 79) {
echo '<img class="ww g40 g40_3" src="img/x.gif" alt="Worldwonder">'; }
if($village->resarray['f99'] >= 80 && $village->resarray['f99'] <= 89) {
echo '<img class="ww g40 g40_4" src="img/x.gif" alt="Worldwonder">'; }
if($village->resarray['f99'] >= 90 && $village->resarray['f99'] <= 100) {
echo '<img class="ww g40 g40_5" src="img/x.gif" alt="Worldwonder">'; }
}
?>
